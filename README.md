...
This repository serves as both a **guide** and a **reference implementation** for all groups enrolled in **SED800 (Summer 2026)**.

Within this repository, you will find examples of all required project artifacts, including:

- Working Agreement  
- Changelog  
- Kanban Board  
- Issues following the course template  
- Milestones that group related issues  
