...
This changelog follows a simplified version of the principles from [Keep a Changelog](https://keepachangelog.com/) and uses semantic, easy-to-read entries to document repository evolution.
...
- Create a Testing and QA Assignment file
...
- Created a linter to check all Document files before merging via PR.
